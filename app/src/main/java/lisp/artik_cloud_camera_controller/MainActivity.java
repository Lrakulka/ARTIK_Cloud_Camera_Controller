...
public class MainActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        onBtn = (Button)findViewById(R.id.make_photo);
        onBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                try {
                    Log.v(TAG, ": make photo button is clicked.");
                    ArtikCloudSession.getInstance().sendMakePhotoActionInDeviceChannelWS();
                } catch (Exception e) {
        ...
        offBtn = (Button)findViewById(R.id.start_recording);
        offBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                try {
                    Log.v(TAG, ": start video button is clicked.");
                    ArtikCloudSession.getInstance().sendStartVideoActionInDeviceChannelWS();
                } catch (Exception e) {
                    Log.v(TAG, "Run into Exception");
                    e.printStackTrace();
                }
        ...
        offBtn = (Button)findViewById(R.id.button_stop_recording);
        offBtn.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                try {
                    Log.v(TAG, ": stop video button is clicked.");
                    ArtikCloudSession.getInstance().sendStopVideoActionInDeviceChannelWS();
                } catch (Exception e) {
                    Log.v(TAG, "Run into Exception");
                    e.printStackTrace();
                }
