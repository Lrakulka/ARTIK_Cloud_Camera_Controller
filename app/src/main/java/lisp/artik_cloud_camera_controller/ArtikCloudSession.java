 ...
 *
 * Modifications copyright (C) 2016 Oleksandr Borysov
 */

package lisp.artik_cloud_camera_controller;
...
public class ArtikCloudSession {
    ...
    private final static String ACTION_MAKE_PHOTO = "makePhoto";
    private final static String ACTION_START_VIDEO = "setOnVideo";
    private final static String ACTION_STOP_VIDEO = "setOffVideo";
    ...
    /**
     * Send action "Make Photo" to ARTIK Cloud
     */
    public void sendMakePhotoActionInDeviceChannelWS() {
        new sendActionInBackground().execute(ACTION_MAKE_PHOTO);
    }

    /**
     * Send action "Start Recording" to ARTIK Cloud
     */
    public void sendStartVideoActionInDeviceChannelWS() {
        new sendActionInBackground().execute(ACTION_START_VIDEO);
    }

    /**
     * Send action "Stop Recording" to ARTIK Cloud
     */
    public void sendStopVideoActionInDeviceChannelWS() {
        new sendActionInBackground().execute(ACTION_STOP_VIDEO);
    }
